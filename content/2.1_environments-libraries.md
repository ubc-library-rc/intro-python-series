...
2. [Download this file](https://github.com/ubc-library-rc/intro-python-series/blob/main/content/exhibit-visits-01.csv)
and put it in the folder you just created.
3. Open your project in VS Code
Open VS code, and then select `File > Open Folder`, and open the folder you created.
